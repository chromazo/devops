...
- [Git Documentation](docs/GitGuide.md): Detailed guide on using Git, including explanations of concepts, commands, and workflows.
...
3. **Read the Git documentation**:
    Open the [Git Documentation](docs/GitGuide.md) file for a detailed guide on using Git.
